...
class OdeResolverImplWithEulerCalculatorImplAndNashornTest extends AbstractTestOdeResolver {
	...
	OdeSolver newOdeResolver(TestDgl testDgl) {
		return new OdeSolverImpl(new EulerCalculatorImpl(new OdeFunctionUtil(Language.Nashorn), testDgl.functionAsString()));
	}
