...
class OdeResolverImplWithEulerCalculatorImplAndJRubyTest extends AbstractTestOdeResolver {
	...
	OdeSolver newOdeResolver(TestDgl testDgl) {
		return new OdeSolverImpl(new EulerCalculatorImpl(new OdeFunctionUtil(Language.JRuby), testDgl.functionAsString()));
	}
